...
const Footer: React.FC = () => {
    const socialLinks = {
        ...
        twitter: "M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616v.064c0 2.298 1.634 4.212 3.793 4.649-.65.177-1.336.213-2.033.184.616 1.923 2.441 3.238 4.6 3.275-1.763 1.385-3.987 2.16-6.413 2.16-.42 0-.834-.025-1.24-.073 2.278 1.463 4.981 2.32 7.881 2.32 9.491 0 14.682-7.859 14.682-14.681 0-.225-.005-.448-.015-.67.998-.724 1.864-1.626 2.559-2.65z",
        ...
        instagram: "M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.85s-.012 3.584-.07 4.85c-.148 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07s-3.584-.012-4.85-.07c-3.252-.148-4.771-1.691-4.919-4.919-.058-1.265-.069-1.645-.069-4.85s.012-3.584.07-4.85c.148-3.225 1.664-4.771 4.919-4.919 1.266.058 1.644.07 4.85.07zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948s.014 3.667.072 4.947c.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072s3.667-.014 4.947-.072c4.358-.2 6.78-2.618 6.98-6.98.059-1.281.073-1.689.073-4.948s-.014-3.667-.072-4.947c-.2-4.358-2.618-6.78-6.98-6.98-1.281-.059-1.689-.073-4.948-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.162 6.162 6.162 6.162-2.759 6.162-6.162-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4s1.791-4 4-4 4 1.79 4 4-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44 1.441-.645 1.441-1.44-.645-1.44-1.441-1.44z",
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div className="md:col-span-2">
                        ...
                        <div className="mt-6 flex space-x-6">
                            <SocialIcon href="https://in.linkedin.com/company/cvoca-association" path={socialLinks.linkedin} />
                            <SocialIcon href="https://x.com/cvocain?lang=en" path={socialLinks.twitter} />
                            <SocialIcon href="https://www.facebook.com/CVOCAAssociation/" path={socialLinks.facebook} />
                            <SocialIcon href="https://www.instagram.com/cvocain/?hl=en" path={socialLinks.instagram} />
                            <SocialIcon href="https://www.youtube.com/@cvocharteredcostaccountant9981" path={socialLinks.youtube} />
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-2 text-sm text-gray-500 dark:text-gray-400">
                            <li>304, Jasmine Apt, Dadar (E), Mumbai 400014</li>
                            <li>+91-9167928622</li>
                            <li>info@cvoca.org</li>
